...
resource "google_container_node_pool" "devcluster_linux_node_pool" {
  name           = "${google_container_cluster.devcluster.name}--linux-node-pool"
  location       = google_container_cluster.devcluster.location
